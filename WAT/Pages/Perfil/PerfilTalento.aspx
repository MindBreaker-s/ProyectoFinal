<%@ Page Title="Perfil de Usuario" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="PerfilTalento.aspx.cs" Inherits="WAT.Pages.PerfilTalento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="../../Recursos/css/PerfilTalento.css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">  
    <section class="PerfilSection d-flex justify-content-center mt-4">
        <div id="left-container">
            <div class="info-label">Trabajo actual: <asp:Label ID="lblTrabajoActual" runat="server" /></div>
            <div class="info-label">Ciudad: <asp:Label ID="lblCiudad" runat="server" /></div>
            <div class="info-label">Educación: <asp:Label ID="lblEducacion" runat="server" /></div>
